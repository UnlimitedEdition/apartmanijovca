...
const content = {
  sr: {
    ...
    rightsText: 'Imate pravo na pristup, ispravku i brisanje Vaših podataka. Zahtev za brisanje možete poslati na email: apartmanijovca@gmail.com',
  ...
  en: {
    ...
    rightsText: 'You have the right to access, correct, and delete your data. You can submit a deletion request via email: apartmanijovca@gmail.com',
  ...
  de: {
    ...
    rightsText: 'Sie haben das Recht auf Zugang, Berichtigung und Löschung Ihrer Daten. Löschanträge können Sie per E-Mail senden an: apartmanijovca@gmail.com',
  ...
  it: {
    ...
    rightsText: 'Hai il diritto di accedere, correggere ed eliminare i tuoi dati. Puoi inviare una richiesta di cancellazione via email: apartmanijovca@gmail.com',
